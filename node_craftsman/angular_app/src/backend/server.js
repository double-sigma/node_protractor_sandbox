...
var Server = function (port) {
    ...
    // Note how we handle the /api/keywords/categories route first, and then the /api/key- words/:id route.
    // This is important, because if the /api/keywords/:id route would be defined first,
    // it would handle /api/keywords/categories requests, interpreting categories as the :id.
